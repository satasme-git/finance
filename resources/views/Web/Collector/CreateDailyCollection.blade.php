                    ...
                    <div class="col-md-6">
                        <fieldset>
                            ...
                            <div class="form-group {{ $errors->has('loan_number') ? ' has-error' : '' }}">
                                ...
                                <input type="text" style="font-weight:bold" class="form-control"  placeholder="Enter Loan Number" id="search" name="loan_number"
                                       @if($errors->any())
                                    ...
                                    <strong style="color: #ff0000">{{ $errors->first('loan_number') }}</strong>
                                </span>
                                @endif
                            </div>
                    ...
                    <div class="col-md-6">
                        <fieldset>
                            ...
                            <div class="form-group {{ $errors->has('loan_rental') ? ' has-error' : '' }}">
                                ...
                                <input type="text" style=" font-weight: bold" placeholder="Rental" class="form-control" id="loan_rental_freq" name="loan_rental_freq"  />
                            ...
                            <div class="form-group {{ $errors->has('loan_period') ? ' has-error' : '' }}">
                                <label>Periods:</label>
                                <span class="pull-right badge badge-success" id="msg_nic"></span>
                                <input type="text" class="form-control" readonly placeholder="Enter Loan Period" id="loan_period" name="loan_period" onkeyup ="loanPerioud();"	@if($errors->any())
                            ...
                            <div class="form-group {{ $errors->has('pay_amount') ? ' has-error' : '' }}">
                                ...
                                <input type="text"  style=" font-weight: bold" class="form-control" placeholder="Enter Loan Term" id="outstanding" name="outstanding"	/>
