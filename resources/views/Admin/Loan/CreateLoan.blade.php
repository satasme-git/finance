                    ...
                    <div class="col-md-6">
                        <fieldset>
                            ...
                            <div class="form-group {{ $errors->has('loan_period') ? ' has-error' : '' }}">
                                ...
                                <!-- onkeyup ="loanPerioud();" -->
                                <span class="pull-right badge badge-success" id="msg_nic"></span>
                                <input type="text" class="form-control" placeholder="Enter Loan Period" id="loan_period" name="loan_period" onkeyup ="loanCalculations();"	@if($errors->any())
		...
		function loanCalculations() {
            ...
            var loan_rate = document.getElementById('loan_rate').value;
              var rate=0;
                ...
                if(loan_amount!=""&&loan_perioud!=""&&aplication_months){
                    document.getElementById('loan_with_interest').value =Math.round(((parseFloat(loantWithInterest) + parseFloat(loan_amount)) + Number.EPSILON) * 100) / 100;
               
                    var aplication_lamountWithInt = document.getElementById('loan_with_interest').value;
                var weeklyDue = aplication_lamountWithInt / loan_perioud;
                document.getElementById('loan_installement').value = parseFloat(Math.round((weeklyDue + Number.EPSILON) * 100) / 100);
                }
    ...
    function loanTerm(id){
        $.ajax({
                    ...
                    for (var i in pro) {
                        ...
                        document.getElementById('loan_term').value = pro[i].category_count;
