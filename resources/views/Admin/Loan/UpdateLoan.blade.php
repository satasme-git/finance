...
<div class="page-header">
    ...
    <div class="page-header-content">
        <div class="page-title">
            <h4><i class="icon-arrow-left52 position-left"></i> <span class="text-semibold">Loan</span> - update loan</h4>
        </div>
...
<div class="content">
    ...
    <form action="/admin/edit_loan/{{$loans->id}}"  method="POST">
        {{csrf_field()}}
                    ...
                    <div class="col-md-6">
                        <fieldset>
                            ...
                            <div class="form-group {{ $errors->has('creditor_nic') ? ' has-error' : '' }}">
                                ...
                                <input type="hidden" class="form-control"  id="cre_id" name="cre_id" value="{{$loans->cre_id}}"/>
                                <input type="text" style="font-weight:bold" class="form-control"  placeholder="Enter NIC Number" value="{{$loans->cre_nic_number}}" id="search" name="creditor_nic"
                                       @if($errors->any())
                            ...
                            <div class="form-group {{ $errors->has('user_first_Name') ? ' has-error' : '' }}">
                                ...
                                <input type="text" class="form-control" readonly placeholder="First Name" id="cre_first_Name" value="{{$loans->cre_first_Name}}" name="cre_first_name"
                                       @if($errors->any())
                            ...
                            <div class="form-group {{ $errors->has('user_last_Name') ? ' has-error' : '' }}">
                                ...
                                <input type="text" class="form-control" readonly placeholder="Last Name" id="last_name" name="cre_last_Name" value="{{$loans->cre_last_Name}}"	@if($errors->any())
                            ...
                            <div class="form-group {{ $errors->has('user_nic_number') ? ' has-error' : '' }}">
                                ...
                                <input type="text" class="form-control" readonly placeholder="Phone Number" id="cre_phone_number" name="cre_phone_number" value="{{$loans->cre_phone_number}}"	@if($errors->any())
                            ...
                            <div class="form-group {{ $errors->has('cre_address') ? ' has-error' : '' }}">
                                <label>Address:</label>
                                <textarea rows="5" cols="5" class="form-control" readonly placeholder="Address" id="cre_address" name="cre_address" > @if($errors->any()){{old('cre_address')}}@elseif(!empty($records->cre_address)){{$records->cre_address}}@endif {{$loans->cre_address}}</textarea>
                            ...
                            <div class="form-group {{ $errors->has('loan_term') ? ' has-error' : '' }}">
                                ...
                                <input type="text" class="form-control" placeholder="Enter Loan Term" id="loan_term" name="loan_term" value="{{$loans->loan_term}}"	@if($errors->any())
                                       value="{{old('loan_term')}}""
                    ...
                    <div class="col-md-6">
                        <fieldset>
                            ...
                            <div class="form-group {{ $errors->has('loan_amount') ? ' has-error' : '' }}">
                                ...
                                <input type="text" style=" font-weight: bold" placeholder="Enter Loan Amount" class="form-control" id="loan_amount" name="loan_amount" value="{{$loans->loan_amount}}" onkeyup ="loanCalculations();"	@if($errors->any())
                            ...
                            <div class="form-group {{ $errors->has('loan_rental') ? ' has-error' : '' }}">
                                ...
                                <select data-placeholder="Select Rental" class="form-control select"  id="loan_rental" name="loan_rental" >
                                    ...
                                    <option  @if($loans->loan_rental_freq=="Monthly") selected  @endif  value="Monthly">Monthly</option>
                                    <option  @if($loans->loan_rental_freq=="Weekly") selected  @endif value="Weekly">Weekly</option>
                                    <option  @if($loans->loan_rental_freq=="Daily") selected  @endif value="Daily">Daily</option>
							...
							<div class="form-group {{ $errors->has('loan_with_interest') ? ' has-error' : '' }}">
                                ...
                                <span class="pull-right badge badge-success" id="msg_nic"></span>
                                <input type="text" readonly style=" font-weight: bold" class="form-control" placeholder="Enter Loan With Interest" id="loan_with_interest" name="loan_with_interest" value="{{$loans->loan_installement}}"	@if($errors->any())
                            ...
                            <div class="form-group {{ $errors->has('loan_period') ? ' has-error' : '' }}">
                                <label>Periods:</label>
                                <span class="pull-right badge badge-success" id="msg_nic"></span>
                                <input type="text" class="form-control" placeholder="Enter Loan Period" id="loan_period" name="loan_period" onkeyup ="loanPerioud();" value="{{$loans->loan_period}}"	@if($errors->any())
                            ...
                            <div class="form-group {{ $errors->has('loan_installement') ? ' has-error' : '' }}">
                                ...
                                <span class="pull-right badge badge-success" id="msg_nic"></span>
                                <input type="text" readonly style=" font-weight: bold" class="form-control" placeholder="Enter Installement" id="loan_installement" name="loan_installement" value="{{$loans->loan_installement}}"	@if($errors->any())
                            ...
                            <div class="form-group {{ $errors->has('loan_start_date') ? ' has-error' : '' }}">
                                ...
                                <span class="pull-right badge badge-success" id="msg_nic"></span>
                                <input type="date" class="form-control" placeholder="Enter Loan Term" id="loan_start_date" name="loan_start_date" value="{{$loans->loan_start_date}}"	@if($errors->any())
