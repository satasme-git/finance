...
@section('content')
            ...
            @if(Session::has('msg'))
                            {!! Session::get('msg') !!} 
             @endif
            <form action="{{url('admin/edit_user')}}" enctype="multipart/form-data" method="POST">
			{{csrf_field()}}
						<div class="panel panel-flat">
							<div class="panel-body">
                                ...
                                <img id="user-photo" class="bevel-black" src="{{asset('/')}}images/avatar.png" >
                                @else
                                <img id="user-photo" width="100px" class="bevel-black" src="{{asset('/')}}images/user/{{$users->user_image}}" >
                                @endif
                                </div>
